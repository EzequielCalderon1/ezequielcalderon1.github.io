...
export default function Hero({ onOpenPresentation }) {
  return (
    <section
      ...
      >
        ...
        <div className="col-span-12 sm:col-span-4 flex flex-wrap gap-3 sm:justify-center">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-ps-red text-white text-sm font-semibold rounded-full hover:bg-[#c8152f] active:scale-[0.98] transition-all focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ps-red shadow-md"
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
