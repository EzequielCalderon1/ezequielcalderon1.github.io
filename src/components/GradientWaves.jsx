...
/* GradientWaves — https://reactbits.dev/backgrounds/gradient-waves
   Adaptado: 'use client' para el App Router y el contenedor con estilo inline
   (Next.js no permite CSS global desde componentes). */
...
const GradientWaves = ({
  ...
  useEffect(() => {
    ...
    /* El contenido de la filmina se dibuja encima del canvas, así que el canvas
       nunca recibiría pointermove: se escucha en window y se proyecta sobre su
       rectángulo. */
  ...
  return <div ref={containerRef} style={CONTAINER_STYLE} className={className} />
}
